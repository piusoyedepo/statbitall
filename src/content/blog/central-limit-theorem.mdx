...
import chartImage from '../../assets/images/a1-clt.png';
...
<Image src={chartImage} alt="Three panels showing an exponential population and its sampling distributions at n=5 and n=30" />
...
<ColabButton href="https://colab.research.google.com/github/piusoyedepo/statbitall/blob/main/notebooks/a1-central-limit-theorem.ipynb" />
