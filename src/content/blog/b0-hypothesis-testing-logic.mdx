...
import chartImage from '../../assets/images/b0-hypothesis-testing-chart.png';
...
<Image src={chartImage} alt="t-distribution null distribution with two-tailed rejection regions shaded at alpha = 0.05, with observed t statistic marked" />
