...
import chartImage from '../../assets/images/a4-variance.png';
...
<Image src={chartImage} alt="Three panels showing same mean with different variance, standard deviation vs standard error, and Bessel's correction" />
...
<ColabButton href="https://colab.research.google.com/github/piusoyedepo/statbitall/blob/main/notebooks/a4-variance-standard-deviation.ipynb" />
